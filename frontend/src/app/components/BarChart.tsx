  ...
  return (
    <>
      <Card className="sm:mx-auto sm:max-w-2xl bg-gray-400 rounded-lg">
        ...
        />
        <Divider />
        <div className="mb-2 flex items-center space-x-3 bg-black">
          <Switch
            id="comparison"
